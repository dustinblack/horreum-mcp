...
export class AlertingService {
   ...
   * @throws ApiError
   */
  public static alertingServiceChangeDetectionModels(): CancelablePromise<
   ...
   * @throws ApiError
   */
  public static alertingServiceDefaultChangeDetectionConfigs(): CancelablePromise<
    Array<ChangeDetection>
  > {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static alertingServiceExpectations(): CancelablePromise<
    Array<RunExpectation>
  > {
    return __request(OpenAPI, {
      method: 'GET',
